...
export class Iovec {
    ...
    constructor() {
        ...
        _define_property(this, "buf_len", void 0)
    }
}
export class Ciovec {
    static read_bytes(view, ptr) {
...
export class Dirent {
    ...
    constructor(next_cookie, name, type) {
        _define_property(this, "d_next", void 0);
        _define_property(this, "d_ino", 1n);
        _define_property(this, "d_namlen", void 0);
        _define_property(this, "d_type", void 0);
        _define_property(this, "dir_name", void 0);
...
export class Fdstat {
    ...
    constructor(filetype, flags) {
        _define_property(this, "fs_filetype", void 0);
        _define_property(this, "fs_flags", void 0);
        _define_property(this, "fs_rights_base", 0n);
        _define_property(this, "fs_rights_inherited", 0n);
...
export class Filestat {
    ...
    constructor(filetype, size) {
        _define_property(this, "dev", 0n);
        _define_property(this, "ino", 0n);
        _define_property(this, "filetype", void 0);
        _define_property(this, "nlink", 0n);
        _define_property(this, "size", void 0);
        _define_property(this, "atim", 0n);
        _define_property(this, "mtim", 0n);
        _define_property(this, "ctim", 0n);
...
export class PrestatDir {
    ...
    constructor(name_len) {
        _define_property(this, "pr_name_len", void 0);
...
export class Prestat {
    ...
    constructor() {
        _define_property(this, "tag", void 0);
